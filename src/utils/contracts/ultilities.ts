...
export const getProvider = async () => {
  ...
  console.log('CURRENT_NET.chainId', CURRENT_NET.chainId);
  console.log('process.env.REACT_APP_NET_RPC_URL,', process.env.REACT_APP_NET_RPC_URL);
...
export const preContractRequest = async (
  ...
  console.log('preContractRequest');
  ...
  console.log('CURRENT_NET', CURRENT_NET);
